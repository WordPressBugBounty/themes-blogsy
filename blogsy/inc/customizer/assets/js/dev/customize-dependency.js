;( function( $ ) {
	...
	var blogsyDependencies = {
		...
		init: function() {
			...
			wp.customize.control.each( function( control ) {
				self.showBlogsyControl( control );
			});
					...
					wp.customize( master, function( setting ) {
						var setupControl = function( control ) {
							...
							isDisplayed = function() {
								return self.showBlogsyControl( wp.customize.control( slave ) );
							};
		 ...
		 * @returns {bool}
		 */
		showBlogsyControl: function( control ) {
			var self     = this,
				show     = true,
				i;
		 ...
		 *
		 * @since 1.0.0
		 * @param {Object} requirement - The requirement, inherited from showBlogsyControl.
	...
	}; // END var blogsyDependencies

	$( document ).ready( function() {
		blogsyDependencies.init();
	});
