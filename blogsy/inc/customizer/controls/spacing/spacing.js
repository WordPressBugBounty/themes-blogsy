;(function ($) {
	...
	wp.customize.controlConstructor['blogsy-spacing'] = wp.customize.Control.extend(
		{
			...
			ready: function () {
				...
				// Change unit.
				control.container.find( '.blogsy-control-unit input[type="radio"]' ).on(
					'change',
					function () {
						control.save_value();
					}
				...
				control.container.find( '.reset-defaults' ).on(
					...
					function () {
						...
						control.container.find( 'input[type="number"]' ).each(
							function () {
			...
			save_value: function () {
				...
				choice,
				device,
				units       = this.container.find( '.blogsy-control-unit' );
