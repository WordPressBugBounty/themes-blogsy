<?php
/**
 * Blogsy Customizer custom spacing control class.
 *
 * @package     Blogsy
...
if ( ! class_exists( 'Blogsy_Customizer_Control_Spacing' ) ) :
	/**
	 * Blogsy Customizer custom select control class.
	 */
	class Blogsy_Customizer_Control_Spacing extends Blogsy_Customizer_Control {
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'blogsy' );
		...
		protected function content_template() {
			?>
			<div class="blogsy-control-wrapper blogsy-spacing-wrapper<# if ( data.responsive ) { #> blogsy-control-responsive <# } #>">
