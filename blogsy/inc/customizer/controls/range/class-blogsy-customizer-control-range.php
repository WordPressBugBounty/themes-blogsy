...
if ( ! class_exists( 'Blogsy_Customizer_Control_Range' ) ) :
	/**
	 * Blogsy Customizer custom heading control class.
	 */
	class Blogsy_Customizer_Control_Range extends Blogsy_Customizer_Control {
		...
		public function enqueue() {
			parent::enqueue();
			$base_font_size = \Blogsy\Helper::get_option( 'html_base_font_size' );
		...
		protected function content_template() {
			?>
			<div class="blogsy-range-wrapper blogsy-control-wrapper">
				...
				<div class="blogsy-control-wrap" data-unit="{{ data.value['unit'] }}">
