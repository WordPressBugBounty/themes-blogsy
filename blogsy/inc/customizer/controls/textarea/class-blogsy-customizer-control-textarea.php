<?php
/**
 * Blogsy Customizer custom textarea control class.
 *
 * @package     Blogsy
...
if ( ! class_exists( 'Blogsy_Customizer_Control_Textarea' ) ) :
	/**
	 * Blogsy Customizer custom select control class.
	 */
	class Blogsy_Customizer_Control_Textarea extends Blogsy_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="blogsy-control-wrapper blogsy-textarea-wrapper">
