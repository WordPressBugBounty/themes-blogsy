...
if ( ! class_exists( 'Blogsy_Customizer_Control_Datetime' ) ) :
	/**
	 * Blogsy Customizer custom select control class.
	 */
	class Blogsy_Customizer_Control_Datetime extends Blogsy_Customizer_Control {
