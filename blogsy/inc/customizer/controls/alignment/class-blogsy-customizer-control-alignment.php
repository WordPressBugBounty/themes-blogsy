...
if ( ! class_exists( 'Blogsy_Customizer_Control_Alignment' ) ) :
	/**
	 * Blogsy Customizer custom background control class.
	 */
	class Blogsy_Customizer_Control_Alignment extends Blogsy_Customizer_Control {
		...
		public function __construct( $manager, $id, $args = [] ) {
			...
			$this->strings = wp_parse_args(
				isset( $args['strings'] ) ? $args['strings'] : [],
				[
					'top-left'     => __( 'Top Left', 'blogsy' ),
					'top'          => __( 'Top', 'blogsy' ),
					'top-right'    => __( 'Top Right', 'blogsy' ),
					'left'         => __( 'Left', 'blogsy' ),
					'center'       => __( 'Center', 'blogsy' ),
					'right'        => __( 'Right', 'blogsy' ),
					'bottom-left'  => __( 'Bottom Left', 'blogsy' ),
					'bottom'       => __( 'Bottom', 'blogsy' ),
					'bottom-right' => __( 'Bottom Right', 'blogsy' ),
				]
			);

			$this->icons = wp_parse_args(
				isset( $args['icons'] ) ? $args['icons'] : [],
				[
		...
		protected function content_template() {
			?>
			<div class="blogsy-alignment-wrapper blogsy-control-wrapper">
				...
				<div class="blogsy-alignment-control">

					<# if ( ! data.choices['top-left'] && ! data.choices['top'] && ! data.choices['top-right'] ) { #>
						<div class="button-group blogsy-top">
							<label class="blogsy-left {{{ data.choices['top-left']}}}">
							...
							<label class="blogsy-center {{{ data.choices['top']}}}">
							...
							<label class="blogsy-right {{{ data.choices['top-right']}}}">
					...
					<# if ( ! data.choices['left'] && ! data.choices['center'] && ! data.choices['right'] ) { #>
						<div class="button-group blogsy-middle">
							<label class="blogsy-left {{{ data.choices['left']}}}">
							...
							<label class="blogsy-center {{{ data.choices['center']}}}">
							...
							<label class="blogsy-right {{{ data.choices['right']}}}">
					...
					<# if ( ! data.choices['bottom-left'] && ! data.choices['bottom'] && ! data.choices['bottom-right'] ) { #>
						<div class="button-group blogsy-bottom">
							<label class="blogsy-left {{{ data.choices['bottom-left']}}}">
							...
							<label class="blogsy-center {{{ data.choices['bottom']}}}">
							...
							<label class="blogsy-right {{{ data.choices['bottom-right']}}}">
