;( function ( $ ) {
	...
	wp.customize.controlConstructor['blogsy-background'] = wp.customize.Control.extend(
		{
			...
			ready: function () {
				...
				control.container.find( 'input[type=range]' ).on(
					'mousedown',
					function () {

						range       = $( this );
						range_input = range.parent().children( '.blogsy-range-input' );
						...
						range.mousemove(
							function () {
								...
								clearTimeout( blogsy_range_input_number_timeout );

								blogsy_range_input_number_timeout = setTimeout(
									function () {
