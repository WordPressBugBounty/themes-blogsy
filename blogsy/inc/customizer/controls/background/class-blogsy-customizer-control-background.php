<?php
/**
 * Blogsy Customizer custom background control class.
 *
 * @package Blogsy
...
if ( ! class_exists( 'Blogsy_Customizer_Control_Background' ) ) :
	/**
	 * Blogsy Customizer custom background control class.
	 */
	class Blogsy_Customizer_Control_Background extends Blogsy_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="blogsy-background-wrapper blogsy-control-wrapper">
				...
				<# if ( data.advanced ) { #>
					...
					<div class="background-image-advanced">
						...
						<div class="background-position">
							...
							<div class="blogsy-range-wrapper">
								...
								<div class="blogsy-control-wrap">
									...
									<input
										...
										value="{{ data.value['background-position-x'] }}"  />
									<span class="blogsy-range-unit">%</span>
								</div>
							</div>
