 ...
 * @access public
 */
class Blogsy_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'blogsy-generic-notice';
	...
	/**
	 * Blogsy_Hiding_Section constructor.
	 *
	...
	public function __construct( WP_Customize_Manager $manager, $id, array $args = [] ) {
		...
		add_action( 'customize_controls_enqueue_scripts', [ $this, 'enqueue' ], 10, 1 );
	}
	...
	public function enqueue() {
		Blogsy_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
				class="blogsy-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
	 ...
	 * @return bool
	 */
	public function create_plugin_install_button( $slug, $settings = [] ) {
		return Blogsy_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
