 ...
 */
class Blogsy_Customizer_Control_Gallery extends Blogsy_Customizer_Control {
	...
	public function __construct( $manager, $id, $args = [] ) {
		...
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			[
				'select'       => __( 'Select Images', 'blogsy' ),
				'change'       => __( 'Modify Gallery', 'blogsy' ),
				'default'      => __( 'Default', 'blogsy' ),
				'remove'       => __( 'Remove', 'blogsy' ),
				'placeholder'  => __( 'No images selected', 'blogsy' ),
				'frame_title'  => __( 'Select Gallery Images', 'blogsy' ),
				'frame_button' => __( 'Choose Images', 'blogsy' ),
			]
		);
	}
