...
if ( ! class_exists( 'Blogsy_Customizer_Widget_Search' ) ) :

	/**
	 * Blogsy Customizer widget class
	 */
	class Blogsy_Customizer_Widget_Search extends Blogsy_Customizer_Widget {
		...
		public function __construct( array $args = [] ) {
			...
			$this->name        = __( 'Search', 'blogsy' );
			$this->description = __( 'A search form for your site.', 'blogsy' );
		...
		public function form(): void {
			...
			if ( ! empty( $this->styles ) ) {
				?>
				<p class="blogsy-widget-search-style">
